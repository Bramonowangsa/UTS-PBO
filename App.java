...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        obj1.setNama("Ultraman");
        obj1.setNip(12345678);
        obj1.setTgl_Lahir("20/11/1990");
        obj1.setAlamat("bandung");
        obj1.setTahun_Masuk(2019);
       
        Dosen obj2 = new Dosen();
        obj2.setJurusan("Informatika");
        obj2.setNidn(24112002);
        obj2.setNama("Power ranger");
        obj2.setNip(2100019192);
        obj2.setTgl_Lahir("11/02/1985");
        obj2.setAlamat("Jakarta");
        obj2.setTahun_Masuk(2017);
